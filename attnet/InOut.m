classdef InOut < handle
    ...
    methods( Access = public )
        ...
        function demo( this, fid, setid )
            ...
            for s = 1 : bsize,
                ...
                if ~isempty( lids ), 
                    ...
                    if gt( end ) ~= signBgd, error( 'Wrong fgd/bgd label.' ); end;
                    cname = 'bgd';
                    dnameTl = cname;
                    dnameBr = cname;
                end;
        ...
        function [ net, netName ] = provdInitNet( this )
            ...
            layers{ end }.forward = @InOut.forward;
            layers{ end }.backward = @InOut.backward;
    ...
    methods( Access = private )
        ...
        function [ sid2iid, sid2tlbr, sid2flip, sid2gt ] = ...
            ...
            numLyr = this.db.getNumClass * 2 + 1;
